        ...
        <div className="mx-auto flex items-center md:w-[42rem] md:px-8 xl:px-0">
          <div className="w-full">
            ...
            <ol className="mb-6 flex items-center text-center text-sm font-medium text-gray-500 sm:text-base lg:mb-12 dark:text-gray-400">
              <li className="flex items-center after:mx-6 after:hidden after:h-1 after:w-12 after:border-b after:border-gray-200 after:content-[''] sm:after:inline-block xl:after:mx-10 dark:after:border-gray-700">
