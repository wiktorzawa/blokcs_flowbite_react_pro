        ...
        <div className="mx-auto flex items-center md:w-[42rem] md:px-8 xl:px-0">
          <div className="w-full">
            ...
            <ol className="mb-6 flex items-center text-center text-sm font-medium text-gray-500 sm:text-base lg:mb-12 dark:text-gray-400">
              <li className="flex items-center text-primary-600 after:mx-6 after:hidden after:h-1 after:w-12 after:border-b after:border-b-gray-200 sm:after:inline-block sm:after:content-[''] xl:after:mx-10 dark:text-primary-500 dark:after:border-b-gray-700">
              ...
              <li className="flex items-center after:mx-6 after:hidden after:h-1 after:w-12 after:border-b after:border-b-gray-200 after:content-[''] sm:after:inline-block xl:after:mx-10 dark:after:border-b-gray-700">
                <div className="flex items-center after:mx-2 after:text-gray-200 after:content-['/'] sm:block sm:after:hidden dark:after:text-gray-500">
            ...
            <h1 className="mb-4 text-2xl font-extrabold tracking-tight text-gray-900 sm:mb-6 dark:text-white">
              Account details
            </h1>
            <form action="#">
              ...
              <div className="flex flex-col space-y-3 md:flex-row md:space-x-3 md:space-y-0">
                <Button
                  color="gray"
                  href="#"
                  className="hover:bg-gray-100 hover:text-primary-600 md:w-1/2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white [&>span]:py-3 [&>span]:text-sm"
                >
                  Prev: Personal Info
                </Button>
                <Button
