...
export function EmailVerificationSixDigitCode() {
  return (
    <section className="bg-white px-4 py-8 lg:py-0 dark:bg-gray-900">
      <div className="lg:flex">
        ...
        <div className="mx-auto flex items-center md:w-[42rem] md:px-8 xl:px-0">
          <div className="w-full">
            ...
            <ol className="mb-6 flex items-center text-center text-sm font-medium text-gray-500 sm:text-base lg:mb-12 dark:text-gray-400">
              <li className="flex items-center text-primary-600 after:mx-6 after:hidden after:h-1 after:w-12 after:border-b after:border-gray-200 sm:after:inline-block sm:after:content-[''] xl:after:mx-10 dark:text-primary-500 dark:after:border-gray-700">
                <div className="flex items-center after:mx-2 after:text-gray-200 after:content-['/'] sm:after:hidden md:flex-col dark:after:text-gray-500">
                  <svg
              ...
              <li className="flex items-center text-primary-600 after:mx-6 after:hidden after:h-1 after:w-12 after:border-b after:border-gray-200 after:content-[''] sm:after:inline-block xl:after:mx-10 dark:text-primary-500 dark:after:border-gray-700">
                <div className="flex items-center after:mx-2 after:text-gray-200 after:content-['/'] sm:after:hidden md:flex-col dark:after:text-gray-500">
                  <svg
                    className="mr-2 h-4 w-4 shrink-0 sm:mx-auto sm:mb-2 sm:h-6 sm:w-6"
                    fill="currentColor"
            ...
            <form action="#">
              <div className="my-4 flex space-x-2 sm:space-x-4 md:my-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    type="text"
                    className="block h-12 w-12 rounded-lg border border-gray-300 bg-white py-3 text-center text-2xl font-extrabold text-gray-900 focus:border-primary-500 focus:ring-primary-500 sm:h-16 sm:w-16 sm:py-4 sm:text-4xl dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                  />
                </div>
                <div>
              ...
              <p className="mb-4 rounded-lg bg-gray-50 p-4 text-sm text-gray-500 md:mb-6 dark:bg-gray-800 dark:text-gray-400">
